...
<p>Die Lehrveranstaltung »Erziehungswissenschaftliche Grundfragen pädagogischen Denkens und Handelns« führt in Themen und Fragestellungen der Allgemeinen und Historischen Erziehungswissenschaft ein. Sie setzt sich folgendermaßen zusammen:
</p>

<div class="panel-group" id="accordion-general-info">
  <div class="panel panel-default">
	<div class="panel-heading">
	  <h4 class="panel-title">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-general-info" href="#collapseOne">
			Online-Lektionen
		</a>
	  </h4>
	</div>
  ...
  <div class="panel panel-default">
	<div class="panel-heading">
	  <h4 class="panel-title">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-general-info" href="#collapseTwo">
		  Texte
		</a>
	  </h4>
	</div>
  ...
  <div class="panel panel-default">
	<div class="panel-heading">
	  <h4 class="panel-title">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-general-info" href="#collapseThree">
	...
	<div id="collapseThree" class="panel-collapse collapse">
	  <div class="panel-body">
		...
		<div class="alert alert-info"><a href="http://www.ph-karlsruhe.de/institute/ph/ew/etpm/mentoring/" target="_blank">Wer Interesse an der Zusatzqualifikation des Mentorings hat und selbst Mentor/Mentorin werden möchte, kann sich nach bestandener Prüfung zum Zertifikatsstudium anmelden</a>.</div>
	  </div>
	</div>
  </div>
  <div class="panel panel-default">
	<div class="panel-heading">
	  <h4 class="panel-title">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-general-info" href="#collapseFour">
		  Prüfung
		</a>
	  </h4>
	</div>
...
<a class="btn btn-primary btn-block download-info" data-name="Allgemeine Informationen und Termine" href="{{ action('Synthesise\Http\Controllers\DownloadController@getFile', ['type' => 'pdf' , 'file' => 'Allgemeine Informationen und Termine']) }}">Allgemeine Informationen und Termine <span class="glyphicon glyphicon-file"></span></a>
