...
<a class="btn btn-primary btn-block download-info" data-name="Allgemeine Informationen und Termine" href="{{ action('DownloadController@getFile', ['type' => 'pdf' , 'file' => 'Allgemeine Informationen und Termine']) }}">Allgemeine Informationen und Termine <span class="glyphicon glyphicon-file"></span></a>
