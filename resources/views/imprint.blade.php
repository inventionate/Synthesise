...
<div class="column">
  ...
  <p>Pädagogische Hochschule Karlsruhe<br>
  Bismarckstr. 10<br>
  76133 Karlsruhe<br>
  </p>
  <h2>Vertreten durch:</h2>
  <p>Apl. Prof. Dr. Timo Hoyer</p>

  <h2>Kontakt:</h2>
  <p>
  Telefon: +49 721 925 4910<br>
  E-Mail: <a href="mailto:timo.hoyer@ph-karlsruhe.de">timo.hoyer@ph-karlsruhe.de</a><br>
  </p>

  <h2 class="ui header">Haftungsausschluss:</h2>

  <h3 class="ui header">Haftung für Inhalte</h3>
  ...
  <h3 id="rechtshinweise" class="ui header">Haftung für Links</h3>
  ...
  <h3 class="ui header">Urheberrecht</h3>
  ...
  <h2 class="ui header">Datenschutzerklärung:</h2>

  <h3 class="ui header">Datenschutz</h3>
  ...
  <h3 class="ui header">Piwik Web Analytics</h3>
  <p>Unsere Website verwendet Piwik, dabei handelt es sich um einen sogenannten Webanalysedienst. Piwik verwendet sog. »Cookies«, das sind Textdateien, die auf Ihrem Computer gespeichert werden und die unsererseits eine Analyse der Benutzung der Webseite ermöglichen. Zu diesem Zweck werden die durch den Cookie erzeugten Nutzungsinformationen (einschließlich Ihrer gekürzten IP-Adresse) an unseren Server übertragen und zu Nutzungsanalysezwecken gespeichert, was der Webseitenoptimierung unsererseits dient. Ihre IP-Adresse wird bei diesem Vorgang umge­hend anony­mi­siert, so dass Sie als Nutzer für uns anonym bleiben. Die durch den Cookie erzeugten Informationen über Ihre Benutzung dieser Webseite werden nicht an Dritte weitergegeben. Sie können die Verwendung der Cookies durch eine entsprechende Einstellung Ihrer Browser Software verhindern, es kann jedoch sein, dass Sie in diesem Fall nicht sämtliche Funktionen dieser Website voll umfänglich nutzen können.</p>
  ...
  <h4 class="class="ui header"">Widerspruch</h4>
