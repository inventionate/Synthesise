...
<main id="main-content-{{ Request::segment(1) }}" class="ui stackable page grid">
  ...
  E-Mail: <a href="mailto:hoyer@ph-karlsruhe.de">hoyer@ph-karlsruhe.de</a><br>
  </p>
  ...
  <h3 class="ui header">Datenschutzerklärung für die Nutzung von Piwik Analytics</h3>
