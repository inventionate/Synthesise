...
class LectionCest
{
   ...
   public function _before(FunctionalTester $I)
   {
    ...
    public function test_change_cuepoint(FunctionalTester $I)
    {
      ...
      // Ersten Note ansehen
      $I->amOnPage('/online-lektionen/Sozialgeschichte%201');
        $I->sendAjaxGetRequest('/online-lektionen/Sozialgeschichte%201/getnotes', ['cuepointNumber' => 'marker-1']);
        $I->see('Das ist die ERSTE Notiz.');

    // Zweiten Note ansehen
    $I->sendAjaxGetRequest('/online-lektionen/Sozialgeschichte%201/getnotes', ['cuepointNumber' => 'marker-2']);
    ...
    public function test_update_note(FunctionalTester $I)
    {
        ...
        // Note verändern
        $I->sendAjaxPostRequest('/online-lektionen/Sozialgeschichte%201/postnotes', ['note' => 'Das ist die VERAENDERTE Notiz.', 'cuepointNumber' => 'marker-1', '_token' => $token]);
