<?php //[STAMP] d4e4319099baa7cad6d508d8df0f9bae
...
class UnitTester extends \Codeception\Actor
{
     ...
     */
    public function canSeeMethod($object, $method) {
        return $this->scenario->runStep(new \Codeception\Step\ConditionalAssertion('seeMethod', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeMethod($object, $method) {
        return $this->scenario->runStep(new \Codeception\Step\Assertion('seeMethod', func_get_args()));
    }
    ...
    public function canCreate($class) {
        return $this->scenario->runStep(new \Codeception\Step\Action('canCreate', func_get_args()));
    }
