...
<a class="btn btn-primary btn-block download-info" data-name="Allgemeine Informationen und Termine" href="{{ action('DownloadController@getFile', array('type' => 'pdf' , 'file' => 'Allgemeine Informationen und Termine')) }}" data-no-turbolink>Allgemeine Informationen und Termine <span class="glyphicon glyphicon-file"></span></a>
